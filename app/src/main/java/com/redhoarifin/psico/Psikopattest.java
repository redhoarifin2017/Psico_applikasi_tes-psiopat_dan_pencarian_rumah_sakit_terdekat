...
public class Psikopattest extends AppCompatActivity {
...
//            mButtonChoice4.setText(mQuestionLibrary.getChoice(mQuestionNumber,4));
            ...
            Toast.makeText(Psikopattest.this, "It was the last question!", Toast.LENGTH_SHORT).show();
            Intent intent = new Intent(Psikopattest.this, Diagnosa.class);
    ...
    public void onClick(View view) {
        ...
        if (answer.getText() == mAnswer){
            mScore = mScore + 10;
             Toast.makeText(Psikopattest.this, "", Toast.LENGTH_SHORT);
        }else
            Toast.makeText(Psikopattest.this, "", Toast.LENGTH_SHORT);
    ...
    public void onBackPressed() {
        finish();
        Intent on = new Intent(Psikopattest.this, MainActivity.class);
        startActivity(on);
    }
 }